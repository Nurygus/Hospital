...
SECRET_KEY = 'django-insecure-e)(&0w@)1h!tee9&=8h*o$#^3%oh1!$c7@6v*8sy-9a!!!wmk@'
...
TEMPLATES = [
    {
        ...
        'libraries':{
            'index': 'doctorsApp.templatetags.index',
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "Hospital" / "static", # Hospital static files are global 
]
